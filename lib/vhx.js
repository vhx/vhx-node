...
var resources = {
  ...
  authorizations: require('./resources/vhx.authorizations'),
  collections:    require('./resources/vhx.collections'),
  videos:         require('./resources/vhx.videos')
};

function VHX(key, version) {
  var _this     = this,
      defaults  = require('./vhx.defaults'),
